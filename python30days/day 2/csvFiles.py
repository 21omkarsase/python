...
# with open("python 30 days/day2/files/suv_data.csv") as csvfile:
# 	csvreader = csv.reader(csvfile)
# 	data = list(csvreader)
# 	print(data, '\n')

# # reading csv file as list of dictionary
# with open("python 30 days/day2/files/suv_data.csv", 'r') as csvfile:
...
with open("python 30 days/day2/files/users.csv", 'w', newline = '') as csvfile:
...
# with open("python 30 days/day2/files/users2.csv", 'w', newline = '') as csvfile:
